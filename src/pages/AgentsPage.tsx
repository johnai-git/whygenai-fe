...
export function AgentsPage() {
  ...
  // Set loading state to true and close the modal
  setIsLoading(true);
  setIsModalOpen(false); // Close modal when creating the agent
  ...
  try {
    ...
    // Reset loading state after the agent creation is complete
    setIsLoading(false);
  }
};
    ...
    <div className="max-w-6xl mx-auto">
      ...
      {isLoading ? (
        <div className="flex justify-center items-center space-x-2">
          ...
          <p className="text-gray-600">Creating Agent...</p>
        </div>
      ) : (
